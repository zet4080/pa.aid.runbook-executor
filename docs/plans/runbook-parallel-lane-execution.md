...
- [x] **ARC-1368** — Conductor: auto-provision feature git worktree for HIGH stories Depends on ARC-1367 (auto-claim must fire first)
...
- [x] Execute ARC-1370 — Conductor: auto-update issue status and archive story artifacts on completion Depends on ARC-1358, ARC-1360, ARC-1369
  - [x] Lint / tests pass
